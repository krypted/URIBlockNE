...
class FilterSettingsController: UITableViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        try? RuleManager().create(rule: Rule(ruleType: .host("jrsworld.co"), isAllowed: true))
        self.loadRules()
    ...
    func loadRules() {
        do {
            ...
            var appRules:[Rule] = []
            var hostRules:[Rule] = []
            appRules.append(Rule(ruleType: Test.RuleType.hostFromApp(host: "jrsworld.co", app: ".com.apple.mobilesafari"), isAllowed: true))
